class Vem < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/ryo-arima/vem/releases/download/v0.1.0-202510191002/vem_Darwin_arm64.tar.gz"
    sha256 "7699f396ea0a5c79ac671c08bf37a3d922ca819facf70e7bbe6cad272bca8a65"
  else
    url "https://github.com/ryo-arima/vem/releases/download/v0.1.0-202510191002/vem_Darwin_x86_64.tar.gz"
